...
class AsyncDoneOp(_ods_ir.OpView):
  ...
  def __init__(self, bundle, called_computation, execution_thread, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def async_done(bundle, called_computation, execution_thread, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(AsyncDoneOp(bundle=bundle, called_computation=called_computation, execution_thread=execution_thread, loc=loc, ip=ip))
...
def async_update(bundle, called_computation, execution_thread, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(AsyncUpdateOp(bundle=bundle, called_computation=called_computation, execution_thread=execution_thread, loc=loc, ip=ip))
  ...
  def __init__(self, result, inputs, call_target_name, *, has_side_effect=None, backend_config=None, api_version=None, called_computations=None, custom_call_schedule=None, operand_layouts=None, result_layouts=None, output_operand_aliases=None, loc=None, ip=None):
    ...
    if output_operand_aliases is not None: attributes["output_operand_aliases"] = (output_operand_aliases if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_787')) else
          _ods_ir.AttrBuilder.get('anonymous_787')(output_operand_aliases, context=_ods_context))
    results.extend(result)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
  ...
  def __init__(self, results_, inputs, *, fusion_kind=None, output_operand_aliases=None, loc=None, ip=None):
    ...
    if output_operand_aliases is not None: attributes["output_operand_aliases"] = (output_operand_aliases if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_823')) else
          _ods_ir.AttrBuilder.get('anonymous_823')(output_operand_aliases, context=_ods_context))
